...
public class StudentController extends BaseHttpServlet {
    ...
    protected byte[] handlePost(HttpServletRequest request)
        ...
        if (studentId == null || classId == null || studentName == null || studentGender == null) {
            return falseResponse("请输入学生Id, 所属班级, 姓名, 性别");
        }
        ...
        Student student =
                new Student(studentId, queryClass.getClassId(), studentName, studentGender);
        try {
